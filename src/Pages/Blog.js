...
import {Media,Row, Col, Container, Card, ListGroup, ListGroupItem } from 'react-bootstrap'
                    ...
                    <Col md="9">
                        <div className="m-5">
                            ...
                            <div>
                                ...
                                <p>
                                    Lorem i6ypSsjOuzCGYZdMntqiaiopNk0Ofy9v8l
                                </p>
                            </div>
                        </div>
                    </Col>
                    <Col md="3">
                        ...
                        <Card className="mt-3" bg="light">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ;asl asd  BcraN77bMXS2lhshszb2Jk
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
